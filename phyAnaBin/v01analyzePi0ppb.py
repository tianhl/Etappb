...
class AnalyzeEtappb:
  ...
  def registryHist(self):
    ...
    self.__hist2D_7 = TH2F('h2_7', 'Dalitz Plot 5C', 50, 0, 8, 50, 0, 8)
    ...
    self.__hist1D_0 = TH1F('h1_0', 'M_{#gamma#gamma} 4C', 100, 0.0, 0.5)
    self.__hist1D_0.GetXaxis().SetTitle('M_{#gamma#gamma} (GeV)')
    self.__hist1D_0.GetYaxis().SetTitle('Entries/')

    self.__hist1D_1 = TH1F('h1_1', 'M_{#gamma#gamma} after cut #pi or J/#psi', 100, 0.0, 0.5)
    self.__hist1D_1.GetXaxis().SetTitle('M_{#gamma#gamma} (GeV)')
    self.__hist1D_1.GetYaxis().SetTitle('Entries/')

    self.__hist1D_2 = TH1F('h1_2', 'M_{#gamma#gamma} after cut 4C #chi^{2}', 100, 0.01, 0.5)
    self.__hist1D_2.GetXaxis().SetTitle('M_{#gamma#gamma} (GeV)')
    self.__hist1D_2.GetYaxis().SetTitle('Entries/')

    self.__hist1D_3 = TH1F('h1_3', 'M_{#gamma#gamma} after cut momentum and #theta', 100, 0.1, 0.17)
    ...
    self.__hist1D_8 = TH1F('h1_8', 'M_{#gamma#gamma p} 5C', 100, 0, 8)
    self.__hist1D_8.GetXaxis().SetTitle('M_{#gamma#gamma p}^{2} (GeV)')
    self.__hist1D_8.GetYaxis().SetTitle('Entries/')
  
    self.__hist1D_9 = TH1F('h1_9', 'M_{#gamma#gamma #bar{p}}  5C', 100, 0, 8)
    self.__hist1D_9.GetXaxis().SetTitle('M_{#gamma#gamma #bar{p}}^{2} (GeV)')
    self.__hist1D_9.GetYaxis().SetTitle('Entries/')
    self.__hist1D_9.SetLineColor(2)

    self.__hist1D_10 = TH1F('h1_10', 'M_{p#bar{p}} 5C', 100, 0, 10)
    self.__hist1D_10.GetXaxis().SetTitle('M_{p#bar{p}}^{2} (GeV)')
  ...
  def cut_0(self):
    ...
    #  return False
    if TMath.Abs(3.097-mDiPro) < 0.04:
      return False
  ...
  def cut_2(self):
    ...
    if p_theta < cutValue2 and p_theta > cutValue1\
  ...
  def cut_3(self):
    ...
    if mDiPho >0.12  and mDiPho < 0.15:
      return 1
  ...
  def loop(self):
    ...
    for eachEntry in xrange(self.__tr.GetEntries()):
      if self.__t_evt[0] == 5877334:
	print 'evt 5877334: ', self.__t_4chi2[0], ' ', self.__t_4C_diPro_mass_2[0]
	  ...
	  if self.cut_2(): # cut  mometum and angle
	    ...
	    if self.cut_3() == 1:  # cut eta
	      ...
	      if self.cut_4(): # cut 5c chi2 > 30
                ...
                self.__hist2D_6.Fill(TMath.Sqrt(self.__t_4C_diPho_mass_2[0]), TMath.Sqrt(self.__t_4C_diPro_mass_2[0]))
                self.__hist2D_7.Fill(self.__t_4C_pb_eta_mass_2[0], self.__t_4C_p_eta_mass_2[0])
                self.__hist1D_8.Fill(self.__t_4C_p_eta_mass_2[0])
                self.__hist1D_9.Fill(self.__t_4C_pb_eta_mass_2[0])
                self.__hist1D_10.Fill(self.__t_4C_diPro_mass_2[0])
