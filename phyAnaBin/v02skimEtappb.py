...
class AnalyzeEtappb:
  ...
  def __commitInput(self):
    ...
    print  ' self.__chain: ', self.__chain
    self.__inf_t = Inf_t()
  ...
  def __commitOutput(self):
    ...
    self.__tr.Branch('evt'                   , self.__t_evt                   , 'evt/l'                )
    self.__tr.Branch('pdgid'                 , self.__t_pdgid                 , 'pdgid[10]/l'              )
  ...
  def __excute(self):  
    s = str(self.__inf_t.run[0]) + ' ' + str(self.__inf_t.evt[0]) + ' chain: '
    for i in xrange(10):
      self.__t_pdgid[i] = self.__inf_t.pdgid[i]
      if self.__inf_t.pdgid[i] != 0:
    ...
    self.__t_evt[0]  = self.__inf_t.evt[0]
    ...
    ##########  
    C5_p_eta_mass_2  = (self.__inf_t.t5CgamE[0]  + self.__inf_t.t5CgamE[1]  + self.__inf_t.t5CpiE[1] ) ** 2 -\
    ...
    ##########  
    C4_p_eta_mass_2  = (self.__inf_t.t4CgamE[0]  + self.__inf_t.t4CgamE[1]  + self.__inf_t.t4CpiE[1] ) ** 2 -\
    ...
    ##########  
    C5_pb_eta_mass_2 = (self.__inf_t.t5CgamE[0]  + self.__inf_t.t5CgamE[1]  + self.__inf_t.t5CpiE[0] ) ** 2 -\
    ...
    ##########  
    C4_pb_eta_mass_2 = (self.__inf_t.t4CgamE[0]  + self.__inf_t.t4CgamE[1]  + self.__inf_t.t4CpiE[0] ) ** 2 -\
    ...
    ##########  
    C5_p_momentum = self.__inf_t.t5CpiPx[1] ** 2 +\
    ...
    ##########  
    self.__t_5C_p_momentum_x[0]         = self.__inf_t.t5CpiPx[1]
    self.__t_5C_p_momentum_y[0]         = self.__inf_t.t5CpiPy[1]
    self.__t_5C_p_momentum_z[0]         = self.__inf_t.t5CpiPz[1]
    self.__t_5C_p_momentum_e[0]         = self.__inf_t.t5CpiE[1] 

    ##########  
    self.__t_4C_p_momentum_x[0]         = self.__inf_t.t4CpiPx[1]
    self.__t_4C_p_momentum_y[0]         = self.__inf_t.t4CpiPy[1]
    self.__t_4C_p_momentum_z[0]         = self.__inf_t.t4CpiPz[1]
    self.__t_4C_p_momentum_e[0]         = self.__inf_t.t4CpiE[1] 

    ##########  
    C4_p_momentum = self.__inf_t.t4CpiPx[1] ** 2 +\
    ...
    ##########  
    C5_pb_momentum = self.__inf_t.t5CpiPx[0] ** 2 +\
    ...
    ##########  
    self.__t_5C_pb_momentum_x[0]         = self.__inf_t.t5CpiPx[0]
    self.__t_5C_pb_momentum_y[0]         = self.__inf_t.t5CpiPy[0]
    self.__t_5C_pb_momentum_z[0]         = self.__inf_t.t5CpiPz[0]
    self.__t_5C_pb_momentum_e[0]         = self.__inf_t.t5CpiE[0] 

    ##########  
    self.__t_4C_pb_momentum_x[0]         = self.__inf_t.t4CpiPx[0]
    self.__t_4C_pb_momentum_y[0]         = self.__inf_t.t4CpiPy[0]
    self.__t_4C_pb_momentum_z[0]         = self.__inf_t.t4CpiPz[0]
    self.__t_4C_pb_momentum_e[0]         = self.__inf_t.t4CpiE[0] 

    ##########  
    C4_pb_momentum = self.__inf_t.t4CpiPx[0] ** 2 +\
