...
class AnalyzeEtappb:
  ...
  def __commitInput(self):
    ...
    #self.__chain.SetBranchAddress('pidDedxChi2'  , self.__inf_t.pidDedxChi2  )
    #self.__chain.SetBranchAddress('pidTof1Chi2'  , self.__inf_t.pidTof1Chi2  )
  ...
  def loop(self, maxEntry = -999):
	...
	continue
      ...
      #self.__t_pidDedxChi2[0]    = 9999.    
      #self.__t_pidTof1Chi2[0]    = 9999.    
  ...
  def __excute(self):  
    ...
    if(C4_pb_momentum>0):
      self.__t_4C_pb_momentum[0] = C5_pb_momentum
