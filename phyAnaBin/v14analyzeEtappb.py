...
class AnalyzeEtappb:
  ...
  def registryHist(self):
    ...
    self.__hist1D_8 = TH1F('h1_8', 'M_{#gamma#gamma p}', 100, 2, 8)
    self.__hist1D_8.GetXaxis().SetTitle('M_{#gamma#gamma p}^{2} (GeV)')
    self.__hist1D_8.GetYaxis().SetTitle('Entries/')
  
    self.__hist1D_9 = TH1F('h1_9', 'M_{#gamma#gamma #bar{p}}', 100, 2, 8)
    ...
    self.__hist1D_11 = TH1F('h1_11', 'M_{#eta}', 100, 0.5, 0.6)
    self.__hist1D_11.GetXaxis().SetTitle('M_{#eta} (GeV)')
	...
	print 'begin: ',  eachEntry 
	  ...
	  if self.cut_2(): # cut  mometum and angle
		...
		#print s  
                ...
                self.__hist1D_11.Fill(TMath.Sqrt(self.__t_4C_diPho_mass_2[0]))
                print TMath.Sqrt(self.__t_4C_diPho_mass_2[0])
	        ...
	        self.sigline.append(str(TMath.Sqrt(self.__t_4C_diPho_mass_2[0]))+'\n')
  ...
  def finalize(self):
    ...
    of = TFile('of.root', 'recreate')
    self.__hist1D_11.Write()
    of.Close()
#    ###################################
